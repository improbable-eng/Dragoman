...
const SET_TLS_CLIENT_KEY_PATH_ERROR = 'SET_TLS_CLIENT_KEY_PATH_ERROR';
const SET_TLS_CLIENT_CERT_PATH_ERROR = 'SET_TLS_CLIENT_CERT_PATH_ERROR';
...
export const setTlsClientKeyPathError = actionHelpers.actionCreator<boolean>(SET_TLS_CLIENT_KEY_PATH_ERROR);
export const setTlsClientCertPathError = actionHelpers.actionCreator<boolean>(SET_TLS_CLIENT_CERT_PATH_ERROR);
